const featuresData = [
  {
    id: 1,
    icon: (
      <svg width="40" height="41" viewBox="0 0 40 41" className="fill-yellow">
        <path
          opacity="0.5"
    ...
    paragraph:
      " It includes a code editor with syntax highlighting, auto-completion, and debugging tools. It also includes a library of pre-built functions and classes that can be used to quickly create complex programs. Additionally, the engine supports multiple programming languages, including C++, Java, Python, and JavaScript.",
  },
  {
    id: 1,
    icon: (
      <svg width="40" height="40" viewBox="0 0 40 40" className="fill-yellow">
        <path
          opacity="0.5"
    ...
    paragraph:
      "that allow developers to quickly identify and fix errors in their code. It includes an integrated debugger that can be used to step through code line by line or set breakpoints for more detailed analysis. Additionally, the engine has an integrated profiler that can be used to measure the performance of code and identify areas for improvement.",
  },
  {
    id: 1,
    icon: (
    ...
    title: "Support for CC platforms",
    paragraph:
      "such as Amazon Web Services (AWS) and Microsoft Azure which allow developers to deploy their applications in the cloud without having to manage physical servers or hardware infrastructure. This makes it easier for developers to scale their applications as needed without having to worry about managing hardware resources or dealing with complex configurations.",
  },
  {
    id: 1,
    icon: (
      <svg width="40" height="45" viewBox="0 0 40 45" className="fill-yellow">
        <path
          opacity="0.5"
    ...
    title: "Support for VCS",
    paragraph:
      "This allows developers to easily track changes made to their code over time and collaborate with other developers on projects. Additionally, the engine supports automated testing frameworks such as JUnit and TestNG which allow developers to quickly test their code for errors before releasing it into production environments.",
  },
];
