...
const Footer = () => {
  return (
    <>
      <footer
        className="wow fadeInUp relative z-10 bg-yellow bg-opacity-5 pt-16 md:pt-20 lg:pt-24"
        data-wow-delay=".1s"
      >
          ...
          <div className="flex">
            <div className="w-full px-4">
              <div className="mb-6 max-w-[360px] lg:mb-8">
                <Link href="/" className="mx-0 inline-block">
                  <Image
                ...
                <div className="flex">
                  ...
                  >
                    <svg width="19" height="14" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" className="fill-current hover:text-yellow">
        ...
        <div className="bg-yellow/10 py-8">
        ...
        <div className="absolute right-0 top-14 z-[-1]">
          ...
          >
            <circle opacity="0.8" cx="49.5" cy="49.5" r="49.5" fill="#ffd700" />
            <mask
              id="mask0_94:899"
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#ffd700" stopOpacity="0.62" />
              ...
              >
                ...
                <stop offset="1" stopColor="#ffd700" stopOpacity="0.51" />
              </linearGradient>
              <linearGradient
